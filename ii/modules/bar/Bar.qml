    ...
    Variants {
        ...
        LazyLoader {
            ...
            component: PanelWindow { // Bar window
                ...
                readonly property int centerSideModuleWidth: (useShortenedForm == 2) ? Appearance.sizes.barCenterSideModuleWidthHellaShortened : (useShortenedForm == 1) ? Appearance.sizes.barCenterSideModuleWidthShortened : Appearance.sizes.barCenterSideClockModuleWidth
                ...
                Item { // Bar content region
                    ...
                    RowLayout { // Middle section
                        ...
                        VerticalBarSeparator {
                            visible: Config.options.bar.borderless && (Config.options.bar.weather.enable || Config.options.bar.prayer.enable)
                        }
                    }
                        ...
                        Item {
                            ...
                            RowLayout {
                                ...
                                Loader {
                                    Layout.leftMargin: 8
                                    Layout.fillHeight: true
                                    active: Config.options.bar.prayer.enable
